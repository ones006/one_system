...
*/
	 ...
	 */
	$config['site_title']		   = "Alus System Application";
	 ...
	 **/
	$config['message_start_delimiter'] = "<div  class='message info'>";
	 ...
	 **/
	$config['error_start_delimiter'] = "<div  class='message error'>";
	...
	/**
	 * Success Start Delimiter
	 **/
	$config['success_start_delimiter'] = "<div  class='message success'>";
	...
	/**
	 * Warning Start Delimiter
	 **/
	$config['warning_start_delimiter'] = "<div  class='message warning'>";
	
	/**
	 * Warning End Delimiter
	 **/
